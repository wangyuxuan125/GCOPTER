                        ...
                        const std::vector<CorridorRecord> &corridors = {})
        {
            ...
            if (header)
            {
                output << "schema_version,run_id,timestamp_s,experiment_tag,requested_method,method,"
                          ...
                          "map_seed,route_seed,fixed_start_goal,start_x,start_y,start_z,goal_x,goal_y,goal_z,"
            ...
            output << std::setprecision(17)
                   ...
                   << record.map_seed << ',' << record.route_seed << ','
                   << record.fixed_start_goal << ',' << record.start_x << ',' << record.start_y << ','
