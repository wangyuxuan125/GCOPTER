...
- Schema v10 records timing, geometry, trajectory results, constrained piece count, sampled corridor penalty/violation before and after optimization, plus map/route seeds, fixed endpoints, budget-exchange diagnostics and key map/dynamics parameters needed to audit fair comparisons.
