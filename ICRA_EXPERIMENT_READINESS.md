...
- Schema v7 records timing, geometry, trajectory results, constrained piece count, sampled corridor penalty/violation before and after optimization, plus map seed, exact endpoints and key map/dynamics parameters needed to audit fair comparisons.
